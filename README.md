[![Build Status](https://travis-ci.org/taktikorg/architecto-exercitationem.svg?branch=master)](https://travis-ci.org/taktikorg/architecto-exercitationem)
[![npm (scoped)](https://img.shields.io/npm/v/menubar.svg)](https://www.npmjs.com/package/menubar)
[![dependencies Status](https://david-dm.org/taktikorg/architecto-exercitationem/status.svg)](https://david-dm.org/taktikorg/architecto-exercitationem)
...
- To create a native menu, you can use `tray.setContextMenu(contextMenu)`, and pass this custom tray to menubar: `const mb = menubar({ tray });`. See [this example](https://github.com/taktikorg/architecto-exercitationem/tree/master/examples/native-menu) for more information.
